		...
		<CardContent>
			...
			>
				<div class="flex flex-col justify-center w-full my-2">
					...
					<p
						class="text-2xl font-semibold text-center dark:text-gray-100"
					>
						No such cat...
					</p>
					<p
						class="text-lg text-center text-gray-500 dark:text-grey-400"
					>
						Poor kitty... Let's praise the cat gods for its safe
						return home.
					</p>
				</div>
